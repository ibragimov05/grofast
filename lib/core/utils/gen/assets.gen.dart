...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/grofast.svg
  SvgGenImage get grofast => const SvgGenImage('assets/icons/grofast.svg');

  /// File path: assets/icons/password_lock.svg
  SvgGenImage get passwordLock =>
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/grofast_logo.png
  AssetGenImage get grofastLogo =>
      const AssetGenImage('assets/images/grofast_logo.png');
  ...
  /// List of all assets
  List<AssetGenImage> get values => [grofastLogo, onboardingImage];
}
